...
cp ./secrets-to-seal/tanzu-sync/tanzu-sync-values.sops.yaml ../clusters/taplab/cluster-config/dependent-resources/

cp ./ytt-outputs/tap-non-sensitive-values.yaml             ../clusters/taplab/cluster-config/values/
cp ./secrets-to-seal/values/tap-sensitive-values.sops.yaml ../clusters/taplab/tanzu-sync/app/sensitive-values/
