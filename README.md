...
Current version TAP/tbs-deps 1.8.0-rc.18 / RMQ 1.5.1 / TDS 1.12.0
...
- Need to revisit for WFD wtih 1.8.0-rc.18 as it's still using crossplane which uses full RMQ
